...
$PAGE->set_title('Enviar informes');
$PAGE->set_heading("Enviar informes");
...
echo $OUTPUT->header();
    ...
    if(isset($_POST["materias_id"])){
      ...
      if($m=='*'){
        ...
        redirect(new moodle_url("/local/infoprofe/inform_primini.php",array('m'=>'*')));
      
      }
    }
   

    $mform = new send_course_form(new moodle_url("/local/infoprofe/inform_primini.php"), array('m'=>$m));
