            ...
            success : function(json) {
                ...
                if(json!=false){
                    ...
                    for(var element in json){
                        ...
                        html+=  '<option class="optmat" value="'+element.id+'">'+element.name+'</option>'; 
    
                    }
                    //console.log(html);
                    $('select[name="materias_id"]').append(html);
                    
                }
            },
            error : function(xhr, status) {
                alert('5 Disculpe, ocurrio un problema');
            },
            complete : function(xhr, status) {
                //alert('Petición realizada');
            }
...
$('select[name="ano_id"]').change(function(){
